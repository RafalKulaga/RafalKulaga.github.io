...
<br/><br/>
My name is Rafal and I come from Poland, but since almost 4 years I have lived abroad. After finishing my bachelor's studies in a vibrant city of Wroclaw, I moved to United Kingdom, where I worked at Bentley Motors with focus on driving simulation. Driven by enthusiasm for cars and virtual development, I decided to pursue my further career goals in Munich - city that not only is the Europe's biggest automotive hub but is also home to a great university. At Technical University of Munich I successfully completed Computational Science and Engineering master's degree. Moreover, in the course of studies, I became interested in data science and data-driven approaches, which encouraged me to write the thesis in this field. Finally, shortly before the end of the last semester, I joined Siemens as an intern and stayed there until the end of March 2020.  For more details please check the Résumé and Projects pages.
<br/><br/>
